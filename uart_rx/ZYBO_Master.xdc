...
##IO_L24P_T3_34
#set_property PACKAGE_PIN P15 [get_ports {reset_0}]
...
##IO_L9P_T1_DQS_34
#set_property PACKAGE_PIN T16 [get_ports {s_0[1]}]
...
###LEDs
###IO_L23P_T3_35
#set_property PACKAGE_PIN M14 [get_ports {data_out_0[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {data_out_0[0]}]

###IO_L23N_T3_35
#set_property PACKAGE_PIN M15 [get_ports {data_out_0[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {data_out_0[1]}]

###IO_0_35
#set_property PACKAGE_PIN G14 [get_ports {data_out_0[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {data_out_0[2]}]

###IO_L3N_T0_DQS_AD1N_35
#set_property PACKAGE_PIN D18 [get_ports {data_out_0[3]}]
...
##Pmod Header JB
##IO_L15P_T2_DQS_34
#set_property PACKAGE_PIN T20 [get_ports {i_RX_Serial_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {i_RX_Serial_0}]

##IO_L15N_T2_DQS_34
#set_property PACKAGE_PIN U20 [get_ports {o_RX_DV_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_DV_0}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[7]}]

#IO_L5N_T0_34
set_property PACKAGE_PIN T15 [get_ports {o_RX_Byte_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[6]}]

#IO_L6P_T0_34
set_property PACKAGE_PIN P14 [get_ports {o_RX_Byte_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[5]}]

#IO_L6N_T0_VREF_34
set_property PACKAGE_PIN R14 [get_ports {o_RX_Byte_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[4]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[3]}]

#IO_L18N_T2_34
set_property PACKAGE_PIN W16 [get_ports {o_RX_Byte_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[2]}]

#IO_25_35
set_property PACKAGE_PIN J15 [get_ports {o_RX_Byte_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[1]}]

#IO_L19P_T3_35
set_property PACKAGE_PIN H15 [get_ports {o_RX_Byte_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_RX_Byte_0[0]}]
