...
proc create_root_design { parentCell } {
  ...
  set o_RX_Byte_0 [ create_bd_port -dir O -from 7 -to 0 o_RX_Byte_0 ]
  set o_RX_DV_0 [ create_bd_port -dir O o_RX_DV_0 ]
  ...
  connect_bd_net -net UART_RX_0_o_RX_Byte [get_bd_ports o_RX_Byte_0] [get_bd_pins UART_RX_0/o_RX_Byte]
  connect_bd_net -net UART_RX_0_o_RX_DV [get_bd_ports o_RX_DV_0] [get_bd_pins UART_RX_0/o_RX_DV]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_in1_0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins UART_RX_0/i_Clk] [get_bd_pins clk_wiz_0/clk_out1]
