...
signal s_dir            :   integer range 0 to 1:=0;
signal s_counter        :   integer range 0 to 24999:=0;--1ms --50mhz
--signal s_counter        :   integer range 0 to 24999999:=0;--1seg --50mhz
...
type rom_type is array (0 to 1) of std_logic_vector(7 downto 0);
                        ...
                        if(switch='1')then
                            case state is
                                ...
                                when wait_time=>
                                    ...
                                    --if(s_counter=1)then
                                    --if(s_counter=24999999)then--1s --50mhz
                                    if(s_counter=24999)then--1ms -- 50mhz
                                        state<=transmit;
                                        s_dir<=0;
                                    else
